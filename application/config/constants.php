...
if ($enviroment == "DEVELOPMENT") {
	define('SSOLOGIN', 'http://desarrollo.ccs.org.co/ssologin/api/ingresar/');
	define('IP_SERVER', 'http://localhost/frameworkcodeigniter/'); //Ip o ruta desarrollo
	define('HOSTNAME', 'localhost');
	define('USERNAME', 'root');
	define('PASSWORD', '');
	define('DATABASE', 'prisma');
